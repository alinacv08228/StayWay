...
type TransferOption = {
    id: number;
    titleKey: "privateTransfer" | "comfortTransfer" | "familyTransfer";
    descriptionKey: "privateDescription" | "comfortDescription" | "familyDescription";
    passengers: string;
    luggage: string;
    duration: string;
    price: number;
...
const transferExtraTranslations: Record<string, Record<string, string>> = {
    English: {
        ...
        heroDescription: "Book a comfortable ride from the airport to your destination — or back again.",
    ...
    Română: {
        ...
        airportTransfers: "Transferuri de la aeroport,",
        madeSimple: "fără complicații.",
        heroDescription: "Rezervă o călătorie confortabilă de la aeroport până la destinație — sau înapoi.",
        ...
        howDescription: "O experiență simplă de transfer, creată pentru a elimina încă un lucru de pe lista planificării călătoriei.",
        ...
        exploreStays: "Explorează cazări",
    },
};
...
export default function TransfersPage() {
    ...
    const t = (key: string) => {
        ...
        return (
            ...
            getTranslation(language, key as Parameters<typeof getTranslation>[1])
        );
    };
    ...
    useEffect(() => {
        const updateTransferLocations = () => {
            setTransferLocations(getTransferLocations());
        };
    ...
    function handleSubmit(event: FormEvent<HTMLFormElement>) {
        ...
        setTimeout(() => {
            document
                .getElementById("transfer-options")
                ?.scrollIntoView({
                    behavior: "smooth",
                    block: "start",
                });
            ...
            <section className="transfers-hero">
                <div className="transfers-container">
                    ...
                    <div className="transfers-search-card">
                        ...
                        <form
                            className={`transfers-form ${transferType === "return" ? "is-return" : ""}`}
                ...
                <div className="transfers-container">
                    ...
                    <div className="transfers-benefits-grid">
                        ...
                        <article className="transfer-benefit-card">
                            ...
                            <h3>{t("onTimePickup")}</h3>

                            <p>
                                Your driver is ready when you are, so you can
                                travel without unnecessary waiting.
                            </p>
                        </article>
                        ...
                        <article className="transfer-benefit-card">
                            ...
                            <h3>{t("travelComfortably")}</h3>

                            <p>{t("comfortDescriptionBenefit")}</p>
                        </article>
                    </div>
                </div>
            </section>
                            ...
                            >
                                <div className="transfer-option-top">
                                    <span className="transfer-option-badge">
                                        {option.id === 1 ? "01" : option.id === 2 ? "02" : "03"}
                                    </span>
                                ...
                                <div className="transfer-option-details">
                                    <span>
                                        👤 {t("upTo")} {option.passengers} {t("passengers").toLowerCase()}
                                    </span>

                                    <span>
                                        🧳 {option.luggage} {t("suitcases")}
                                    </span>

                                    <span>
                                        ◷ {t("approx")} {option.duration} {t("minutes")}
                                    </span>
                                </div>
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        ...
                                        params.set("optionId", String(option.id));
                                        params.set("optionTitle", t(option.titleKey));
                                        params.set("price", String(option.price));
            ...
            <section className="transfers-how-it-works">
                <div className="transfers-container">
                    <div className="transfers-how-grid">
                        <div className="transfers-section-heading" style={{ transform: "translateY(70px)" }}>
                            <span className="transfers-eyebrow">
                                {t("howItWorks")}
                            </span>
                        ...
                        <div className="transfer-steps">
                            ...
                            <div className="transfer-step">
                                ...
                                <div>
                                    <h3>{t("chooseYourRide")}</h3>

                                    <p>{t("chooseRideDescription")}</p>
                                </div>
                            </div>
...
.transfers-container {
    ...
    .transfers-hero {
        ...
        overflow: visible;
        padding: 88px 0 74px;
    background: linear-gradient(135deg, #f7f3ff 0%, #f3efff 52%, #faf8ff 100%);
    isolation: isolate;
}
...
.transfers-hero::after {
    ...
    inset: auto 0 0;
    height: 1px;
    background: rgba(112, 85, 232, 0.08);
}
...
.transfers-search-card {
    ...
    box-shadow:
    0 28px 70px rgba(69, 49, 125, 0.12),
        0 5px 18px rgba(69, 49, 125, 0.05);
...
.transfers-type-switch button.active {
    color: var(--tw-purple);
        background: #fff;
        box-shadow: 0 5px 14px rgba(80, 57, 150, 0.09);
}
...
.transfer-field:focus-within {
    border-color: #b9aaf5;
    box-shadow: 0 0 0 4px rgba(112, 85, 232, 0.08);
}
...
/* Return fields get their own clean second row.
   Passengers stays on the first row with the main trip details. */
.transfers-form.is-return .return-date-field {
    grid-column: 4;
    grid-row: 2;
}

.transfers-form.is-return .return-time-field {
    grid-column: 5;
    grid-row: 2;
}

.transfers-form.is-return .passengers-field {
    grid-column: 6;
    grid-row: 1;
}

.transfers-form.is-return .transfers-search-button {
    grid-column: 6;
    grid-row: 2;
    width: 100%;
    min-width: 0;
...
.transfers-search-button {
    ...
    border-radius: 15px;
    color: #fff;
    background: linear-gradient(135deg, var(--tw-purple), var(--tw-purple-dark));
    font-weight: 800;
    cursor: pointer;
    box-shadow: 0 12px 25px rgba(112, 85, 232, 0.24);
...
.transfers-cta-button:hover {
    ...
    box-shadow: 0 16px 30px rgba(112, 85, 232, 0.28);
}
...
.transfers-benefits .transfers-section-heading {
    max-width: 700px;
}
...
.transfer-benefit-card {
    ...
    box-shadow: 0 12px 32px rgba(54, 40, 91, 0.045);
    transition: transform 180ms ease, box-shadow 180ms ease;
}

.transfer-benefit-card:hover {
    transform: translateY(-4px);
    box-shadow: 0 20px 40px rgba(54, 40, 91, 0.09);
}
...
.transfers-how-it-works .transfers-section-heading > p,
.transfer-step p {
    color: var(--tw-muted);
    line-height: 1.65;
}
...
.transfer-option-card {
    ...
    border-radius: 24px;
    background: #fff;
    box-shadow: 0 18px 45px rgba(60, 42, 103, 0.08);
...
.transfer-option-card:hover {
    ...
    border-color: #d8cef5;
    box-shadow: 0 28px 58px rgba(60, 42, 103, 0.13);
}
...
.transfer-step {
    ...
    box-shadow: 0 10px 30px rgba(109, 72, 246, 0.08);
...
.transfer-step:hover {
    ...
    border-color: #a78bfa;
    box-shadow: 0 14px 35px rgba(109, 72, 246, 0.14);
}
...
#6d4df5
    ...
    box-shadow:
    0 8px 18px rgba(109, 72, 246, 0.28),
        0 0 0 6px #f0eaff;
}
...
.transfers-cta-card {
    ...
    border-radius: 30px;
    background:
        radial-gradient(circle at 88% 15%, rgba(112, 85, 232, 0.18) 0 90px, transparent 91px),
    linear-gradient(135deg, #eee8ff, #f6f2ff);
    box-shadow: 0 20px 55px rgba(64, 44, 112, 0.08);
}
...
.transfers-cta-button {
    ...
    box-shadow: 0 12px 25px rgba(112, 85, 232, 0.22);
    transition: transform 180ms ease, box-shadow 180ms ease;
}
...
.transfers-how-grid > .transfers-section-heading {
        margin-top: 0;
    }
